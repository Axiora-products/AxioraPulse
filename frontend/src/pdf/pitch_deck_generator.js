...
<div style="background:#fffbf4;padding:40px 70px;">
  ...
  <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:16px;margin-bottom:16px;">
    ...
    <div style="text-align:center;"><div style="font-family:'Playfair Display',serif;font-size:22px;font-weight:900;color:#ff4500;">${crossVal.ai_estimated_claims || 0}</div><div style="font-size:10px;color:rgba(22,15,8,0.5);">AI Estimates</div></div>
  </div>
