        ...
        <div style={{ padding: '24px 28px 22px 32px' }}>
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              ...
              <span
                style={{ width: 1, height: 11, background: 'rgba(22,15,8,0.1)', display: 'block' }}
              />
              <span
                style={{
                  fontFamily: "'Syne',sans-serif",
                    ...
                    >
                      <span
                        style={{
                          ...
                          flexShrink: 0,
                          color:
                            t.value === q.question_type ? 'var(--coral)' : 'rgba(253,245,232,0.5)',
                        }}
                      >
                        {t.icon}
                      </span>
          ...
          {isMx(q.question_type) &&
            (() => {
              ...
              const addRow = () =>
                setMx({
                  ...
                  rows: [
                    ...(mxData.rows || []),
                    {
                      label: `Row ${(mxData.rows || []).length + 1}`,
                      value: `row_${(mxData.rows || []).length + 1}`,
                    },
                  ],
                });
              const addCol = () =>
                setMx({
                  ...
                  columns: [
                    ...(mxData.columns || []),
                    {
                      label: `Col ${(mxData.columns || []).length + 1}`,
                      value: `col_${(mxData.columns || []).length + 1}`,
                    },
                  ],
                });
              const updRow = (ri, v) => {
              ...
              const updCol = (ci, v) => {
                const cs = [...(mxData.columns || [])];
                cs[ci] = { label: v, value: v.toLowerCase().replace(/\s+/g, '_') };
                setMx({ ...mxData, columns: cs });
              };
              const delRow = (ri) =>
                setMx({ ...mxData, rows: (mxData.rows || []).filter((_, j) => j !== ri) });
              const delCol = (ci) =>
                setMx({ ...mxData, columns: (mxData.columns || []).filter((_, j) => j !== ci) });
              return (
                <div
                  className="mx-grid"
                  style={{
                ...
                >
                  {[
                    ['Rows', mxData.rows || [], addRow, updRow, delRow],
                    ['Columns', mxData.columns || [], addCol, updCol, delCol],
...
export default function SurveyCreate() {
  ...
  const [tmplQs, setTmplQs] = useState([
    { _id: 'tq0', question_text: '', question_type: 'short_text', is_required: false },
  ]);
  const [customTemplates, setCustomTemplates] = useState(() => {
    try {
      return JSON.parse(localStorage.getItem('np-custom-templates') || '[]');
    } catch {
      return [];
    }
  });
  ...
  const GALLERY_TEMPLATES = [
    {
      name: 'NPS Survey',
      category: 'Customer',
      desc: 'Measure customer loyalty with the Net Promoter Score methodology.',
      time: '2 min',
      qs: [
        {
        ...
        {
          question_text: 'What is the main reason for your score?',
          question_type: 'long_text',
          is_required: false,
        },
        {
          question_text: 'What could we do to improve?',
          question_type: 'long_text',
          is_required: false,
        },
      ],
    },
    {
      ...
      category: 'Product',
      desc: 'Gather actionable feedback on your product features and UX.',
      time: '3 min',
      qs: [
        {
          question_text: 'How satisfied are you with the product overall?',
        ...
        {
          question_text: 'What feature would you most like to see added?',
          question_type: 'long_text',
          is_required: false,
        },
      ],
    },
    {
      name: 'Employee Pulse',
      category: 'HR',
      desc: 'Quick check-in on team morale, workload, and engagement.',
      time: '4 min',
      qs: [
        {
        ...
        },
        {
          ...
          question_type: 'scale',
          is_required: true,
          description: '1 = Overwhelmed · 10 = Very manageable',
        },
        {
          question_text: 'Do you feel your contributions are recognised?',
    ...
    },
    {
      name: 'Event Feedback',
      category: 'Events',
      desc: 'Capture attendee experience immediately after your event.',
      time: '2 min',
      qs: [
        {
        ...
        {
          question_text: 'What was the highlight of the event?',
          question_type: 'long_text',
          is_required: false,
        },
        { question_text: 'Would you attend again?', question_type: 'yes_no', is_required: true },
      ],
    },
    {
      name: 'Market Research',
      category: 'Research',
      desc: "Understand your target market's attitudes and behaviours.",
      time: '5 min',
      qs: [
        {
        ...
        {
          question_text: 'What factors most influence your purchase decisions?',
          question_type: 'multiple_choice',
          is_required: true,
          options: [
        ...
        {
          question_text: 'How do you typically discover new products like ours?',
          question_type: 'single_choice',
          is_required: false,
          options: [
            { label: 'Social media', value: 'social' },
            { label: 'Word of mouth', value: 'wom' },
    ...
    },
    {
      name: 'Exit Interview',
      category: 'HR',
      desc: 'Understand why team members are leaving and how to improve retention.',
      time: '6 min',
      qs: [
        {
        ...
        {
          question_text: 'What did you value most about working here?',
          question_type: 'long_text',
          is_required: false,
        },
        {
          question_text: 'Would you recommend us as an employer?',
          question_type: 'yes_no',
          is_required: true,
        },
      ],
  ...
  const filteredGallery =
    catFilter === 'All'
      ? GALLERY_TEMPLATES
      : GALLERY_TEMPLATES.filter((t) => t.category === catFilter);
  ...
  const delQ = (id) => {
    ...
    sQs((a) => a.filter((q) => q._id !== id));
  };
  const moveQ = (id, d) =>
    sQs((a) => {
      const i = a.findIndex((q) => q._id === id);
  ...
  const addOpt = (id) =>
    sQs((a) =>
      a.map((q) =>
        q._id === id ? { ...q, options: [...(q.options || []), { label: '', value: '' }] } : q
      )
    );
  const sOpt = (id, i, v) =>
    sQs((a) =>
  ...
  const delOpt = (id, i) =>
    sQs((a) =>
      a.map((q) => (q._id !== id ? q : { ...q, options: q.options.filter((_, j) => j !== i) }))
    );
  ...
  async function save(status = 'draft') {
    ...
    if (qs.some((q) => hasO(q.question_type) && (!q.options || q.options.length < 2)))
      return toast.error('Choice questions need ≥2 options');
    if (status === 'active' && qs.length < 2)
      return toast.error('At least 2 questions are required to publish');
    if (status === 'active' && f.expires_at && isExpired(f.expires_at))
  ...
  const healthColor =
    health >= 70 ? 'var(--sage)' : health >= 40 ? 'var(--saffron)' : 'var(--terracotta)';
  const TABS = [
  ...
  return (
    <div>
        ...
        >
          <div
            style={{
              ...
              width: '100%',
              maxWidth: 480,
              boxShadow: '0 32px 80px rgba(22,15,8,0.2)',
            }}
          >
            <div
              style={{
            ...
            >
              This will replace your current survey title, description, welcome message, and all
              questions with the newly AI-generated ones. This action cannot be undone.
            </p>
            <div style={{ display: 'flex', gap: 12, justifyContent: 'flex-end' }}>
              ...
              <button
                onClick={() => applyAIGeneration(pendingGen)}
                style={{
                  padding: '12px 24px',
                  borderRadius: 999,
                  border: 'none',
        ...
        >
          <div
            style={{
              ...
              boxShadow: '0 64px 160px rgba(22,15,8,0.45)',
              overflow: 'hidden',
            }}
          >
            <div
            ...
            >
              ...
              >
                <div>
                  ...
                  >
                    Validated survey frameworks. Load and customise in seconds.
                  </p>
                </div>
                <button
                  ...
                  onMouseLeave={(e) => {
                    ...
                    e.currentTarget.style.color = 'rgba(22,15,8,0.4)';
                  }}
                >
                  ✕
                </button>
              ...
              >
                {[
                  ...
                  [
                    'mine',
                    `My Templates${customTemplates.length ? ` (${customTemplates.length})` : ''}`,
                  ],
                ].map(([id, lbl]) => (
                  <button
                    key={id}
                    onClick={() => setTmplTab(id)}
                    style={{
                      fontFamily: "'Syne',sans-serif",
                      fontSize: 10,
                      fontWeight: 700,
                      ...
                      background: 'none',
                      cursor: 'pointer',
                      color: tmplTab === id ? 'var(--espresso)' : 'rgba(22,15,8,0.35)',
                      borderBottom:
                        tmplTab === id ? '2px solid var(--coral)' : '2px solid transparent',
                      transition: 'all 0.2s',
                      marginBottom: '-1px',
                    }}
                  >
                    ...
                    {allCats.map((cat) => (
                      <button
                        ...
                        style={{
                          ...
                          textTransform: 'uppercase',
                          border: '1.5px solid',
                          borderColor: catFilter === cat ? tc : 'rgba(22,15,8,0.1)',
                          background: catFilter === cat ? `${tc}12` : 'transparent',
                          color: catFilter === cat ? tc : 'rgba(22,15,8,0.4)',
                          cursor: 'pointer',
                          transition: 'all 0.2s',
                        }}
                      >
                    ...
                    {filteredGallery.map((t, ti) => (
                      <div
                        ...
                        onMouseEnter={(e) => {
                          ...
                          e.currentTarget.style.boxShadow = `0 16px 48px ${tc}18`;
                      ...
                      >
                        <div
                          style={{ height: 4, background: `linear-gradient(90deg,${tc},${tc}60)` }}
                        />
                        ...
                        <div style={{ padding: '8px 18px 18px' }}>
                          <button
                            ...
                            onMouseEnter={(e) => {
                              ...
                              e.currentTarget.style.boxShadow = `0 4px 20px ${tc}45`;
                            }}
                            onMouseLeave={(e) => {
                  ...
                  {!showCreateTmpl ? (
                    <button
                      ...
                      style={{
                        ...
                        padding: '16px 22px',
                        borderRadius: 18,
                        border: '1.5px dashed rgba(22,15,8,0.16)',
                        background: 'transparent',
                        fontFamily: "'Syne',sans-serif",
                        fontWeight: 700,
                        fontSize: 10,
                      ...
                      onMouseLeave={(e) => {
                        e.currentTarget.style.borderColor = 'rgba(22,15,8,0.16)';
                        e.currentTarget.style.color = 'rgba(22,15,8,0.4)';
                        e.currentTarget.style.background = 'transparent';
                      }}
                    >
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                        <div>
                          ...
                          <input
                            ...
                            placeholder="e.g. Quarterly Customer Pulse"
                            style={INP}
                            onFocus={fi}
                            onBlur={fo}
                          />
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14 }}>
                          <div>
                            ...
                            <input
                              value={tmplNewCat || tmplCat}
                              onChange={(e) => {
                                setTmplNewCat(e.target.value);
                                setTmplCat('');
                              }}
                    ...
                    <div style={{ textAlign: 'center', padding: '64px 0' }}>
                      <div
                        style={{
                          ...
                          height: 56,
                          borderRadius: 16,
                          border: '1.5px dashed rgba(22,15,8,0.12)',
                          display: 'flex',
                          alignItems: 'center',
                          justifyContent: 'center',
                          margin: '0 auto 18px',
                      ...
                      >
                        Save your survey as a reusable template above.
                      </div>
                    </div>
                  ) : (
                    <div
                    ...
                    >
                      {customTemplates.map((t) => (
                        <div
                          ...
                          onMouseEnter={(e) => {
                            e.currentTarget.style.borderColor = tc;
                            e.currentTarget.style.boxShadow = `0 8px 32px ${tc}14`;
      ...
      {/* ── PAGE HEADER ── */}
      <div
        style={{ position: 'relative', marginBottom: 56, paddingBottom: 48, overflow: 'hidden' }}
      >
        {/* Atmospheric grain */}
        <div
          style={{
        ...
        <div
          style={{
            ...
            height: 360,
            borderRadius: '50%',
            background: `radial-gradient(circle,${tc}22,transparent 70%)`,
            pointerEvents: 'none',
          }}
        />
        {/* Bottom separator */}
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 28 }}>
                ...
                <div style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
                  <button
                    ...
                    style={{
                      ...
                      transition: 'all 0.2s',
                      boxShadow:
                        aiGenerating || !f.ai_context.trim() ? 'none' : `0 4px 14px ${tc}40`,
                    }}
                  >
                    {aiGenerating ? (
                      <>
                  ...
                  {f.ai_context.trim() && (
                    <button
                      ...
                      onMouseEnter={(e) => {
                        if (!aiGenerating) {
                          e.currentTarget.style.color = 'var(--terracotta)';
                          e.currentTarget.style.borderColor = 'rgba(214,59,31,0.3)';
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. Q3 Customer Satisfaction Study"
                  style={{
                    ...INP,
                    fontSize: 20,
                    fontWeight: 500,
              ...
              >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Shown on the landing screen before Q1"
                    rows={4}
                    style={{ ...INP, borderRadius: 16 }}
                    onFocus={fi}
                    onBlur={fo}
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              ...
              <AISurveySuggestions
                ...
                onAdd={(q) =>
                  sQs((a) => [
                    ...a,
                    { ...newQ(), ...q, _id: 'new_' + Math.random().toString(36).slice(2) },
                  ])
                }
              />
            </div>
                ...
                >
                  <div
                    style={{
                      ...
                      bottom: 0,
                      width: 3,
                      background: f[x.k] ? `linear-gradient(180deg,${tc},${tc}50)` : 'transparent',
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 18, paddingLeft: 8 }}>
                    <div
                      style={{
                        ...
                        height: 44,
                        borderRadius: 14,
                        background: f[x.k] ? `${tc}12` : 'rgba(22,15,8,0.05)',
                        display: 'flex',
                        alignItems: 'center',
                        justifyContent: 'center',
                        color: f[x.k] ? tc : 'rgba(22,15,8,0.32)',
                        transition: 'all 0.25s',
                        flexShrink: 0,
                      }}
                    >
                  ...
                  <div
                    style={{
                      ...
                      height: 26,
                      borderRadius: 999,
                      background: f[x.k] ? tc : 'rgba(22,15,8,0.12)',
                      position: 'relative',
                      transition: 'background 0.25s',
                      flexShrink: 0,
                    }}
              ...
              {f.title ? (
                <div
                  style={{
                    ...
                    color: 'var(--cream)',
                    lineHeight: 1.15,
                    marginBottom: f.description ? 8 : 0,
                  }}
                >
                  {f.title}
                </div>
                ...
                {[
                  ...
                  <div
                    ...
                    style={{
                      ...
                      textAlign: 'center',
                      borderRight:
                        lbl !== 'est. time' ? '1px solid rgba(255,251,244,0.08)' : 'none',
                    }}
                  >
                    <div
                      style={{
