...
const ROLE_COLORS = {
  super_admin: 'rgba(139,92,246,0.10)',
  admin: 'rgba(255,69,0,0.10)',
  manager: 'rgba(255,184,0,0.12)',
  creator: 'rgba(30,122,74,0.10)',
  viewer: 'rgba(22,15,8,0.06)',
};
const ROLE_TEXT = {
  super_admin: '#7C3AED',
  admin: 'var(--coral)',
    ...
    <div style={{ position: 'relative', display: 'inline-block' }} ref={ref}>
      <button
        ...
        style={{
          ...
          color: ROLE_TEXT[value] || 'rgba(22,15,8,0.5)',
          display: 'flex',
          alignItems: 'center',
          gap: 6,
          whiteSpace: 'nowrap',
      ...
      {open && (
        <div
          style={{
            ...
            borderRadius: 14,
            padding: 6,
            boxShadow: '0 16px 48px rgba(22,15,8,0.25)',
            minWidth: '100%',
          }}
        >
            ...
            .map(([v, l]) => (
              <button
                ...
                style={{
                  ...
                  letterSpacing: '0.12em',
                  textTransform: 'uppercase',
                  color: v === value ? 'var(--coral)' : 'rgba(253,245,232,0.7)',
                  borderRadius: 9,
...
export default function TeamManagement() {
  ...
  async function chgRole(uid, newRole) {
    ...
    if (profile.role === 'admin' && newRole === 'super_admin')
      return toast.error('Admins cannot assign the Super Admin role');
    try {
              ...
              >
                ...
                <button
                  onClick={() => {
                    if (hasNoDomains)
                      return toast.error(
                        'Configure approved email domains in Settings before inviting.'
                      );
                    setShowModal(true);
                  }}
                  style={{
                    ...
                    alignItems: 'center',
                    gap: 8,
                    background: hasNoDomains ? 'rgba(22,15,8,0.2)' : 'var(--espresso)',
                    color: 'var(--cream)',
                    fontFamily: 'Syne, sans-serif',
                    fontWeight: 700,
                    fontSize: 11,
                    ...
                    borderRadius: 999,
                    border: 'none',
                    cursor: hasNoDomains ? 'not-allowed' : 'pointer',
                    transition: 'background 0.25s ease',
                  }}
                  onMouseEnter={(e) => {
                    if (!hasNoDomains) e.currentTarget.style.background = 'var(--coral)';
                  }}
                  onMouseLeave={(e) => {
                    if (!hasNoDomains) e.currentTarget.style.background = 'var(--espresso)';
                  }}
                >
                  + Invite member
                </button>
        ...
        {members.map((m) => (
          <div
            ...
            style={{
              background: 'var(--warm-white)',
              borderRadius: 20,
              border: `1.5px solid ${m.is_active === false ? 'rgba(214,59,31,0.12)' : 'rgba(22,15,8,0.07)'}`,
              padding: '20px 22px',
              display: 'flex',
              alignItems: 'center',
              gap: 16,
            ...
            onMouseEnter={(e) =>
              (e.currentTarget.style.boxShadow = '0 12px 40px rgba(22,15,8,0.08)')
            }
                ...
                <div style={{ display: 'flex', gap: 4, flexShrink: 0 }}>
                  {m.is_active === false ? (
                    <button
                      ...
                      onMouseLeave={(e) => {
                        e.currentTarget.style.background = 'rgba(30,122,74,0.1)';
                    ...
                    <button
                      ...
                      onMouseEnter={(e) => {
                        ...
                        e.currentTarget.style.background = 'rgba(214,59,31,0.06)';
                      }}
                      onMouseLeave={(e) => {
                  ...
                  {profile.role === 'super_admin' && (
                    <button
                      ...
                      onMouseLeave={(e) => {
                        e.currentTarget.style.color = 'rgba(22,15,8,0.15)';
                        e.currentTarget.style.background = 'none';
                      }}
                    >
                      <svg
        ...
        >
          <div
            style={{
              ...
              width: '100%',
              maxWidth: 460,
              boxShadow: '0 40px 100px rgba(22,15,8,0.2)',
            }}
              ...
              {['single', 'bulk'].map((m) => (
                <button
                  ...
                  style={{
                    ...
                    border: 'none',
                    borderRadius: 9,
                    background: modalMode === m ? 'var(--cream)' : 'transparent',
                    color: modalMode === m ? 'var(--espresso)' : 'rgba(22,15,8,0.4)',
                    fontFamily: 'Syne, sans-serif',
                    fontWeight: 700,
                    fontSize: 10,
                    letterSpacing: '0.12em',
                    ...
                    cursor: 'pointer',
                    transition: 'all 0.2s',
                    boxShadow: modalMode === m ? '0 2px 8px rgba(22,15,8,0.08)' : 'none',
                  }}
                >
                  {m}
                </button>
              ...
              <div style={{ display: 'flex', gap: 12, marginTop: 4 }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    borderRadius: 999,
                    border: 'none',
                    background: busy ? 'rgba(22,15,8,0.3)' : 'var(--espresso)',
                    color: 'var(--cream)',
                    fontFamily: 'Syne, sans-serif',
                    fontWeight: 700,
                    fontSize: 11,
                  ...
                  onMouseLeave={(e) => {
                    if (!busy) e.currentTarget.style.background = 'var(--espresso)';
                  }}
                >
