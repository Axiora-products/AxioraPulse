    ...
    >
      ...
      >
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          >
            Insights your team{' '}
            <em style={{ fontStyle: 'italic', color: 'var(--saffron)' }}>actually</em> trust.
          </h2>
          <p
            style={{
              fontFamily: 'Fraunces, serif',
          ...
          >
            Set up your workspace in under a minute. No credit card needed. Built for researchers
            who mean business.
          </p>
          <div style={{ display: 'flex', gap: 40 }}>
            {[
              { val: '< 1', unit: 'min', lbl: 'Setup time' },
              { val: '24+', unit: '', lbl: 'Question types' },
              { val: '99.9', unit: '%', lbl: 'Uptime SLA' },
            ].map((st) => (
              <div key={st.lbl}>
                <div
                  style={{
                ...
                >
                  {st.val}
                  <span style={{ color: 'var(--saffron)' }}>{st.unit}</span>
                </div>
                <div
                  style={{
                    fontFamily: 'Syne, sans-serif',
          ...
          {step === 'verify' ? (
            <>
              ...
              >
                ...
                <strong style={{ color: 'var(--espresso)' }}>{f.email}</strong>
              </p>
              <form
                onSubmit={confirm}
            ...
            <>
              ...
              >
                Set up your team&apos;s survey platform
              </p>
              ...
              <form onSubmit={go} style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
                ...
                <div>
                  ...
                  <div
                    ...
                    onBlurCapture={(e) =>
                      (e.currentTarget.style.borderBottomColor = 'rgba(22,15,8,0.12)')
                    }
                  >
                    <input
                      value={f.tenantSlug}
