...
function TabBar({ active, onChange, onScroll }) {
  return (
    <div className="sa-tabs-scroll" style={{ display: 'flex', gap: 2, borderBottom: '1px solid rgba(22,15,8,0.07)', marginBottom: 40, overflowX: 'auto' }} onScroll={onScroll}>
      {TABS.map(t => (
              ...
              {rs.slice(0, 50).map((r, i) => (
                <tr key={r.id} style={{ borderBottom: '1px solid rgba(22,15,8,0.04)', transition: 'background 0.15s' }}
                  ...
                  <td style={{ padding: '11px 12px' }}>
                    <span style={{
                      fontFamily: 'Syne,sans-serif', fontSize: 11, fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase', padding: '3px 10px', borderRadius: 999,
    ...
    <>
      ...
      >
        ...
        <div className="np-page-header" style={{ marginBottom: 32 }}>
          ...
          <div className="sa-header-actions" style={{ display: 'flex', gap: 4, flexWrap: 'wrap', alignItems: 'center', overflowX: 'auto', marginLeft: -550, paddingRight: 8 }}>
        ...
        <div className="sa-tabs-wrapper">
          ...
          <span className={`scroll-indicator ${scrollState}`}>
            {scrollState === "right" && "→"}
            {scrollState === "left" && "←"}
            {scrollState === "both" && "↔"}
          </span>
