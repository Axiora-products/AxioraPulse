  ...
  <div style={{ display: 'flex', alignItems: 'flex-start', gap: 0, lineHeight: 1 }}>
    <span
      style={{
        ...
        color: dark ? 'rgba(253,245,232,0.35)' : 'rgba(22,15,8,0.35)',
        marginRight: 8,
        position: 'relative',
        top: -2,
      }}
    ...
    <span
      style={{
        ...
        fontSize: 24,
        letterSpacing: '-1px',
        color: dark ? 'var(--cream)' : 'var(--espresso)',
        lineHeight: 1,
      }}
    >
      Pulse
    ...
    >
      ...
      >
        ...
        <button
          ...
          onMouseLeave={(e) => (e.currentTarget.style.background = 'rgba(22,15,8,0.07)')}
        >
          ✕
        </button>
        ...
        {step === 'done' ? (
          ...
          <>
            ...
            >
              Enter the code sent to <strong style={{ color: 'var(--espresso)' }}>{email}</strong>{' '}
            ...
            <form onSubmit={reset} style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
              ...
              <motion.button
                ...
                style={{
                  padding: '15px 28px',
                  background: busy ? 'rgba(22,15,8,0.35)' : 'var(--espresso)',
                  color: 'var(--cream)',
                  border: 'none',
                  borderRadius: 999,
                  fontFamily: 'Syne, sans-serif',
    ...
    >
      ...
      >
        ...
        <div
          style={{
            ...
            color: 'transparent',
            WebkitTextStroke: '1px rgba(253,245,232,0.04)',
            letterSpacing: -5,
            lineHeight: 1,
            userSelect: 'none',
            pointerEvents: 'none',
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          >
            Research that <em style={{ fontStyle: 'italic', color: 'var(--saffron)' }}>holds up</em>{' '}
            in a room.
          </h2>
          <p
            style={{
          ...
          <div style={{ display: 'flex', gap: 40 }}>
            {[
              ...
              <div key={s.lbl}>
                ...
                >
                  {s.val}
                  <span style={{ color: 'var(--saffron)' }}>{s.unit}</span>
                </div>
                <div
                  style={{
                    fontFamily: 'Syne, sans-serif',
      ...
      <div
        style={{
          ...
          justifyContent: 'center',
          padding: '60px 56px',
          borderLeft: '1px solid rgba(22,15,8,0.06)',
        }}
      >
        <motion.div
        ...
        >
          <Link to="/" style={{ textDecoration: 'none', display: 'block', marginBottom: 48 }}>
            <Logo dark={false} />
          </Link>
            ...
            <div style={{ marginTop: -12, textAlign: 'right' }}>
              <button
                ...
                onMouseEnter={(e) => {
                  ...
                  e.currentTarget.style.textDecorationColor = 'var(--coral)';
                }}
                onMouseLeave={(e) => {
          ...
          >
            ...
            <Link
              ...
              style={{
                ...
                fontWeight: 500,
                textDecoration: 'none',
                borderBottom: '1px solid rgba(22,15,8,0.2)',
                paddingBottom: 1,
              ...
              onMouseLeave={(e) => {
                ...
                e.currentTarget.style.borderBottomColor = 'rgba(22,15,8,0.2)';
              }}
            >
              Create one →
            </Link>
