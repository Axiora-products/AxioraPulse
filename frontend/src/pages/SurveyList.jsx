          ...
          {STATUS_FILTERS.map((f) => (
            <button
              ...
              style={{
                padding: '10px 16px',
                borderRadius: 999,
                border: `1px solid ${filter === f ? 'transparent' : 'rgba(22,15,8,0.08)'}`,
                cursor: 'pointer',
                fontFamily: 'Syne, sans-serif',
                fontWeight: 700,
                fontSize: 10,
                ...
                textTransform: 'uppercase',
                transition: 'all 0.2s',
                background: filter === f ? 'var(--espresso)' : 'var(--warm-white)',
                color: filter === f ? 'var(--cream)' : 'rgba(22,15,8,0.5)',
              }}
            >
          ...
          {sortOpen && (
            <div
              style={{
                ...
                borderRadius: 14,
                padding: 6,
                boxShadow: '0 16px 48px rgba(22,15,8,0.2)',
                minWidth: '100%',
              }}
            >
              {SORT_OPTIONS.map((o) => (
                <button
                  ...
                  style={{
                    ...
                    letterSpacing: '0.12em',
                    textTransform: 'uppercase',
                    color: sort === o.value ? 'var(--coral)' : 'rgba(253,245,232,0.7)',
                    borderRadius: 9,
            ...
            >
              ...
              <div
                style={{
                  ...
                  background: sv.theme_color || 'var(--coral)',
                }}
              />
              ...
              <div style={{ padding: 24 }}>
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                    <div
                      style={{
                        ...
                        height: 8,
                        borderRadius: '50%',
                        background: STATUS_COLORS[sv.status] || 'rgba(22,15,8,0.25)',
                        boxShadow: sv.status === 'active' ? '0 0 6px rgba(30,122,74,0.5)' : 'none',
                      }}
                    />
                    <span
                      style={{
                        ...
                        textTransform: 'uppercase',
                        color: STATUS_COLORS[sv.status] || 'rgba(22,15,8,0.4)',
                      }}
                    >
                  ...
                  <div style={{ position: 'relative' }} ref={(el) => (menuRef.current[sv.id] = el)}>
                    <button
                      onClick={() => setMenu(menu === sv.id ? null : sv.id)}
                    ...
                    {menu === sv.id && (
                      <div
                        style={{
                          ...
                          borderRadius: 16,
                          padding: 8,
                          boxShadow: '0 24px 60px rgba(22,15,8,0.25)',
                        }}
                      >
                        {[
                          {
                          ...
                          },
                          {
                            ...
                            icon: (
                              <svg
                                ...
                                strokeLinejoin="round"
                              >
                                <path d="M3 20h18M7 20V12M11 20V8M15 20V14M19 20V4" />
                              </svg>
                            ),
                            action: () => {
                              nav(`/surveys/${sv.id}/analytics`);
                              setMenu(null);
                            },
                          },
                          ...
                          hasPermission(profile?.role, 'delete_survey') &&
                            sv.status === 'draft' && {
                              ...
                              action: () => confirmDelete(sv.id, sv.title),
                              danger: true,
                            },
                        ]
                          .filter(Boolean)
                ...
                {sv.expires_at && (
                  <p
                    style={{
                      ...
                      letterSpacing: '0.1em',
                      textTransform: 'uppercase',
                      color: isExpired(sv.expires_at) ? 'var(--terracotta)' : 'rgba(22,15,8,0.4)',
                      marginTop: 4,
                    }}
                  >
