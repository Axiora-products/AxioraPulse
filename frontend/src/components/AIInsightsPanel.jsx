    ...
    try {
      ...
      setErrMsg(
        e.response?.data?.detail ||
          'Could not connect to AI — ensure your OpenAI API key is set on the server.'
      );
      setState('error');
    }
  }
      ...
      >
        ...
        <motion.button
          ...
          style={{
            ...
            borderRadius: 999,
            border: 'none',
            background: analytics.total === 0 ? 'rgba(22,15,8,0.08)' : 'var(--espresso)',
            color: analytics.total === 0 ? 'rgba(22,15,8,0.3)' : 'var(--cream)',
            fontFamily: 'Syne,sans-serif',
            fontWeight: 700,
            fontSize: 10,
            letterSpacing: '0.12em',
            textTransform: 'uppercase',
            cursor: analytics.total === 0 ? 'default' : 'pointer',
            display: 'flex',
            alignItems: 'center',
            gap: 8,
            transition: 'all 0.2s',
            ...
            <>
              <motion.span
                ...
                style={{
                  ...
                  width: 12,
                  height: 12,
                  border: '2px solid rgba(253,245,232,0.3)',
                ...
                {result.topStrengths.map((s, i) => (
                  <div
                    ...
                    style={{
                      ...
                      marginBottom: i < result.topStrengths.length - 1 ? 10 : 0,
                    }}
                  >
                    <span
                      style={{ color: 'var(--sage)', fontWeight: 700, flexShrink: 0, marginTop: 1 }}
                    >
                      ✓
                    </span>
                ...
                {result.improvementAreas.map((a, i) => (
                  <div
                    ...
                    style={{
                      ...
                      gap: 10,
                      alignItems: 'flex-start',
                      marginBottom: i < result.improvementAreas.length - 1 ? 10 : 0,
                    }}
                  >
                    <span
                      style={{
