    ...
    async (q) => {
      ...
      const staticFiltered = STATIC_ACTIONS.filter((a) => {
        ...
        return (
          ...
          a.group.toLowerCase().includes(trimmed)
        );
      });
      ...
      try {
        ...
        const surveyActions = (surveys || []).flatMap((sv) => [
          ...
          {
            id: `sv-analytics-${sv.id}`,
            label: `${sv.title} — Analytics`,
            icon: 'analytics',
            group: 'Surveys',
    ...
    >
      <motion.div
        ...
        style={{
          ...
          borderRadius: 22,
          boxShadow: '0 48px 120px rgba(22,15,8,0.4)',
          overflow: 'hidden',
      ...
      >
        ...
        <div
          style={{
            ...
            gap: 14,
            padding: '20px 24px',
            borderBottom: '1.5px solid rgba(22,15,8,0.07)',
          }}
        >
          <svg
            width="18"
          ...
          {loading ? (
            <div
              style={{
                width: 14,
                height: 14,
                border: '2px solid rgba(22,15,8,0.1)',
        ...
        <div style={{ maxHeight: 520, overflowY: 'auto', padding: '10px 10px' }}>
          {results.length === 0 && !loading && (
            <div style={{ padding: '48px 20px', textAlign: 'center' }}>
              ...
              >
                Try &quot;create&quot;, &quot;settings&quot;, or a survey name
              </div>
            </div>
          )}
                  ...
                  {item.meta && (
                    <span
                      style={{
                        ...
                        color:
                          selected === item._idx
                            ? 'rgba(253,245,232,0.4)'
                            : statusColor[item.meta] || 'rgba(22,15,8,0.3)',
                        flexShrink: 0,
                      }}
                    >
                      {item.meta}
        ...
        <div
          style={{
            padding: '12px 24px',
            borderTop: '1.5px solid rgba(22,15,8,0.06)',
            display: 'flex',
            gap: 18,
            alignItems: 'center',
          }}
