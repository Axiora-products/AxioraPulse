    ...
    (t) => (
      <motion.div
        ...
        style={{
          ...
          padding: '20px 24px',
          minWidth: 280,
          boxShadow: '0 24px 60px rgba(22,15,8,0.35)',
          overflow: 'hidden',
          cursor: 'pointer',
        }}
      ...
      >
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          >
            {count === 1
              ? 'Your first response is in — momentum starts here.'
              : count === 10
                ? 'Double digits — great momentum!'
                : count === 50
                  ? "Fifty responses! You're on a roll."
                  : count === 100
                    ? 'A century! Incredible engagement.'
                    : count === 500
                      ? 'Five hundred! This is serious research.'
