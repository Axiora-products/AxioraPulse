...
const STEPS = [
  {
    ...
    desc: 'Build a survey from scratch or use a template.',
    to: '/surveys/new',
    cta: 'Create survey',
  },
  {
    ...
    desc: 'Activate your survey and copy the share link.',
    to: '/surveys',
    cta: 'Go to surveys',
  },
  {
    ...
    desc: 'Share the link with your audience.',
    to: '/surveys',
    cta: 'View surveys',
  },
  {
    ...
    desc: 'See insights, completion rates, and response data.',
    to: '/surveys',
    cta: 'View analytics',
  },
  {
    ...
    desc: 'Collaborate by sharing survey access.',
    to: '/team',
    cta: 'Go to team',
  },
];
    ...
    >
      ...
      <div
        style={{
          ...
          gap: 16,
          cursor: 'pointer',
          borderBottom: minimised ? 'none' : '1px solid rgba(22,15,8,0.06)',
        }}
                  ...
                  <Link key={step.id} to={step.to} style={{ textDecoration: 'none' }}>
                    <div
                      style={{
                        padding: '14px 16px',
                        borderRadius: 14,
                        border: `1px solid ${done ? 'rgba(30,122,74,0.2)' : 'rgba(22,15,8,0.07)'}`,
                        background: done ? 'rgba(30,122,74,0.04)' : 'var(--cream)',
                        transition: 'all 0.2s',
                        display: 'flex',
                        gap: 10,
                      ...
                      onMouseEnter={(e) => {
                        if (!done) e.currentTarget.style.borderColor = 'var(--coral)';
                      }}
                      onMouseLeave={(e) => {
                        if (!done) e.currentTarget.style.borderColor = 'rgba(22,15,8,0.07)';
                      }}
                    >
                      <div
                        style={{
                          ...
                          height: 28,
                          borderRadius: '50%',
                          background: done ? 'rgba(30,122,74,0.12)' : 'rgba(22,15,8,0.06)',
                          display: 'flex',
                          alignItems: 'center',
                          justifyContent: 'center',
                          flexShrink: 0,
                          color: done ? 'var(--sage)' : 'rgba(22,15,8,0.45)',
                        }}
                      >
                        {done ? (
                          <svg
                      ...
                      <div>
                        <div
                          style={{
                            ...
                            color: done ? 'var(--sage)' : 'var(--espresso)',
                            marginBottom: 2,
