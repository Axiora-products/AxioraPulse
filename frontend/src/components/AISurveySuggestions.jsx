...
export default function AISurveySuggestions({
  survey,
  questions = [],
  onAdd,
  tc = '#FF4500',
            ...
            return (
              <motion.div
                ...
                style={{
                  ...
                  border: `1px solid ${isAdded ? 'rgba(30,122,74,0.2)' : 'rgba(22,15,8,0.08)'}`,
              ...
              >
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div
                    style={{
                      ...
                      color: 'var(--espresso)',
                      lineHeight: 1.4,
                      marginBottom: sug.rationale ? 5 : 0,
                    }}
                  >
                    {sug.text}
                  </div>
                  ...
                  {!isAdded && sug.options && (
                    <div style={{ display: 'flex', flexWrap: 'wrap', gap: 4, marginTop: 7 }}>
                      ...
                      {Array.isArray(sug.options) && sug.options.length > 4 && (
                        <span
                          style={{
                            fontFamily: 'Syne,sans-serif',
                            fontSize: 9,
                ...
                <motion.button
                  ...
                  style={{
                    ...
                    borderRadius: 999,
                    border: 'none',
                    background: isAdded ? 'rgba(30,122,74,0.12)' : tc,
                    color: isAdded ? 'var(--sage)' : '#fff',
                    fontSize: isAdded ? 14 : 18,
                    cursor: isAdded ? 'default' : 'pointer',
                    display: 'flex',
                    alignItems: 'center',
                    justifyContent: 'center',
                    transition: 'all 0.2s',
                    boxShadow: isAdded ? 'none' : `0 3px 12px ${tc}40`,
                  }}
                >
                  {isAdded ? '✓' : '+'}
                </motion.button>
