  ...
  return (
    <div ref={ref} style={{ position: 'relative' }}>
      ...
      <button
        ...
        style={{
          position: 'relative',
          background: open ? 'var(--cream-deep)' : 'none',
          border: 'none',
          cursor: 'pointer',
          padding: '7px',
          borderRadius: 10,
          color: open ? 'var(--espresso)' : 'rgba(22,15,8,0.4)',
          fontSize: 18,
          lineHeight: 1,
          transition: 'all 0.2s',
          display: 'flex',
        ...
        {open && (
          <motion.div
            ...
            style={{
              ...
              borderRadius: 20,
              boxShadow: '0 32px 80px rgba(22,15,8,0.2), 0 2px 8px rgba(22,15,8,0.06)',
          ...
          >
            ...
            <div
              style={{
                ...
                borderBottom: '1px solid rgba(22,15,8,0.06)',
                display: 'flex',
                alignItems: 'center',
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                {unread > 0 && (
                  <button
                    ...
                    onMouseEnter={(e) =>
                      (e.currentTarget.style.background = 'rgba(30,122,74,0.08)')
                    }
                  ...
                  return (
                    <button
                      ...
                      style={{
                        ...
                        gap: 12,
                        padding: '12px 18px',
                        background: isNew ? 'rgba(255,69,0,0.03)' : 'none',
                        border: 'none',
                        borderBottom: '1px solid rgba(22,15,8,0.045)',
                        cursor: 'pointer',
                        textAlign: 'left',
                      ...
                      onMouseEnter={(e) =>
                        (e.currentTarget.style.background = 'rgba(22,15,8,0.03)')
                      }
                      onMouseLeave={(e) =>
                        (e.currentTarget.style.background = isNew ? 'rgba(255,69,0,0.03)' : 'none')
                      }
                    >
                      <span
                        style={{
                          ...
                          height: 28,
                          borderRadius: 8,
                          background: isNew ? 'rgba(255,69,0,0.1)' : 'rgba(22,15,8,0.05)',
                          display: 'flex',
                          alignItems: 'center',
                          justifyContent: 'center',
                          flexShrink: 0,
                          marginTop: 1,
                          color: isNew ? 'var(--coral)' : 'rgba(22,15,8,0.4)',
                          transition: 'all 0.2s',
                        }}
                      >
                        {iconEl(ev.icon)}
