...
export default function DashboardLayout() {
  ...
  function isNavActive(item) {
    ...
    if (item.to === '/surveys')
      return loc.pathname.startsWith('/surveys') && loc.pathname !== '/surveys/new';
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--cream)', cursor: 'none' }}>
      ...
      >
            ...
            return (
              <NavLink
                ...
                style={{
                  ...
                  color: active ? 'var(--cream)' : 'rgba(22,15,8,0.4)',
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                ...
                <>
                  <motion.div
                    ...
                    style={{
                      ...
                      borderRadius: 18,
                      padding: 14,
                      boxShadow: '0 24px 80px rgba(22,15,8,0.3)',
                    }}
                  >
                    {/* User info */}
                    <div
                      style={{
                        ...
                        borderBottom: '1px solid rgba(253,245,232,0.08)',
                        marginBottom: 8,
                      }}
                    >
                      <div
                    ...
                    <Link
                      ...
                      onMouseLeave={(e) => {
                        ...
                        e.currentTarget.style.color = 'rgba(253,245,232,0.45)';
                      }}
                    >
                      <svg
                        width="13"
                    ...
                    <div
                      style={{
                        borderTop: '1px solid rgba(253,245,232,0.08)',
                        marginTop: 4,
                        paddingTop: 4,
                      }}
                    >
                      <button
                        ...
                        onMouseEnter={(e) => {
                          e.currentTarget.style.background = 'rgba(214,59,31,0.15)';
                          e.currentTarget.style.color = 'var(--terracotta)';
                        }}
                        onMouseLeave={(e) => {
                          e.currentTarget.style.background = 'transparent';
                          e.currentTarget.style.color = 'rgba(214,59,31,0.7)';
                        }}
                      >
                        <svg
                          width="13"
          ...
          <button
            ...
            className="np-mobile-nav np-icon-btn"
            style={{
              background: 'none',
              border: 'none',
              padding: 6,
          ...
          >
            {mobileOpen ? (
              <IcoClose size={22} color="var(--espresso)" />
            ) : (
              <IcoMenu size={22} color="var(--espresso)" />
            )}
          </button>
        </div>
      </header>
            ...
            >
                ...
                return (
                  <NavLink
                    ...
                    style={{
                      ...
                      color: active ? 'var(--coral)' : 'rgba(253,245,232,0.45)',
                    }}
                  >
                    {n.label}
                  </NavLink>
              ...
              <NavLink
                ...
                style={({ isActive }) => ({
                  ...
                  color: isActive ? 'var(--coral)' : 'rgba(253,245,232,0.45)',
                })}
              >
                Settings
              </NavLink>
      ...
      >
        ...
        >
          © 2026 Axiora Pulse is a product of Axiora Labs · Built for researchers, by researchers ·
          Hyderabad
        </p>
      </footer>
