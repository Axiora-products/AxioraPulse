...
from db.models import Survey, SurveyAnswer, SurveyQuestion, SurveyResponse, UserProfile
    ...
    try:
        ...
        fallback_data = {
            ...
            "pitch_review": {
                ...
                "strengths": [
                    "Solid validation evidence index",
                    "Clear unit-economic CAC target ratio",
                ],
